      ...
      <section class="cropper-area">
        <!-- <div class="actions">
          ...
          <!-- <a href="#" role="button" @click.prevent="showFileChooser">
            Upload Image </a> -->
          <!-- <a href="#" role="button" @click.prevent="getBase64">
            GetBase64
          </a> 
        </div> -->
...
export default {
  ...
  data() {
    return {
      imgSrc:
        "https://png.pngtree.com/png-vector/20210912/ourlarge/pngtree-summer-landscape-png-image_3911110.jpg",
      cropImg: "",
      data: null,
    };
  },
  methods: {
    ...
    getBase64(){
      this.data = this.$refs.cropper.getCroppedCanvas().toDataURL();
    }
  },
};
</script>
